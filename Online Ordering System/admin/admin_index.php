...
if(isset($_GET['action']) && $_GET['action']=="view"){
	$food_cat = $_GET['cat'];
	$sql = "SELECT *
FROM food, restaurant WHERE restaurant.rest_id = '$admin_id' AND food_cat = $food_cat";
}
else {
$sql = "SELECT *
FROM food, restaurant WHERE restaurant.rest_id = '$admin_id' AND food.rest_id = '$admin_id'";
}
